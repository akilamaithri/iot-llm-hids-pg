...
% TODO: Move to methods section -- threat model definition, metric setup ($\varepsilon$@ESR=0.5), and condition list belong there.
...
% CIC-IoT2023 and WUSTL-IIoT, with results validated over three random seeds.
