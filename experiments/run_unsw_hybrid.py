#!/usr/bin/env python3
"""Run hybrid RAG policy generation on UNSW-NB15 (binary, lazy variant).
...
Expected improvement: 0.7040 → 0.72-0.76 (+2-5%)
"""
...
def main():
    print("[Setup] Loading UNSW-NB15 dataset...")
    ...
    result_file = results_dir / "unsw_hybrid_binary_result.json"
    result_dict = {
    ...
    improvement = result.best_metrics['macro_f1'] - 0.7040
    pct = (improvement / 0.7040) * 100
